...
def main(input_directory, model_path, classifier_output_path, batch_size, num_threads, num_epochs,
         min_num_images_per_class, split_ratio, is_train=True):
    """
...
if __name__ == '__main__':
    main(input_directory='dataset/AlignedOutput', model_path="20180402-114759_model/20180402-114759.pb", classifier_output_path='classifier.pkl',
         batch_size=1, num_threads=16, num_epochs=1,
         min_num_images_per_class=5, split_ratio=0.8, is_train='true')
