...
def recognize_face(emb_array,classifier_filename,imageLocation,boundary_boxes):
    ...
    with open(classifier_filename,'rb') as f:
        ...
        showPhoto(person_names,best_class_probabilities,imageLocation,boundary_boxes)    

def showPhoto(person_names,best_class_probabilities,imageLocation,boundary_boxes):
...
if __name__=='__main__':
    main(imageLocation=driveLocation+'images/image13.jpeg',model_path=driveLocation+'20180402-114759_model/20180402-114759.pb',classifier_output_path=driveLocation+'classifier.pkl')
